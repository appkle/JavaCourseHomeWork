...
public final class KmqBroker { // Broker+Connection
    ...
    public void setComsumerOffset(Kmq kmq, int consumerHashcode){
        kmq.setConsumerOffset(consumerHashcode);
    }

    public void commitSync(Kmq kmq, int consumerHashcode){
        kmq.commitSync(consumerHashcode);
    }
